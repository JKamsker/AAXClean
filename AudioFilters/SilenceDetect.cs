...
{
	internal class SilenceDetect : IFrameFilter
	{
		public List<(TimeSpan, TimeSpan)> Silences { get; }

		private const int BITS_PER_SAMPLE = 16;
		private readonly AacDecoder decoder;
		private readonly BlockingCollection<(uint, short[])> waveSampleQueue;
		private readonly Task encoderLoopTask;

		private readonly short maxAmplitude;
		...
		public bool FilterFrame(uint chunkIndex, uint frameIndex, Span<byte> aacSample)
		{
